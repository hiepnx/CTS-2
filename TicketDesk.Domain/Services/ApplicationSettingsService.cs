...
namespace TicketDesk.Domain.Services
{
    ...
    public class ApplicationSettingsService : IApplicationSettingsService
    {
        ...
        public string[] AvailableTestStatus
        {
            get
            {
                return (string[])GetSettingValue("TestStatusList");
            }
        }
        /// <summary>
        ...
        public string[] AvailableSubCategories
        {
            get
            {
                return (string[])GetSettingValue("SubCategoryList");
            }
        }
        ...
        public string[] AvailableAnalysisStatus
        {
            get { return (string[])GetSettingValue("AnalysisStatusList"); }
        }
