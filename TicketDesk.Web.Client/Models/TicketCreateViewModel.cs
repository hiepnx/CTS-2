...
namespace TicketDesk.Web.Client.Models
{
    public class TicketCreateViewModel
    {
        ...
        public SelectList TestStatusList
        {
            get { return ListUtility.GetStatusList(true, string.Empty); }
        }

        public SelectList SubCategoryList
        {
            get { return ListUtility.GetSubCategoryList(true, string.Empty); }
        }
        ...
        public SelectList AnalysisStatusList
        {
            get { return ListUtility.GetAnalysisStatusList(true, string.Empty); }
        }
        ...
        public SelectList StaffList
        {
            get { return ListUtility.GetStaffList(true, Security.CurrentUserName); }
        }
    }
}