...
namespace TicketDesk.Web.Client.Helpers
{
    ...
    public class SelectListUtility
    {
        ...
        public SelectList GetStatusList(bool includeEmpty, string selectedtestStatus)
        {
            return GetSelectList(Settings.ApplicationSettings.AvailableTestStatus, includeEmpty, "-- select --", selectedtestStatus);
        }

        public SelectList GetSubCategoryList(bool includeEmpty, string selectedSubCategory)
        {
            return GetSelectList(Settings.ApplicationSettings.AvailableSubCategories, includeEmpty, "-- select --", selectedSubCategory);
        }
        ...
        public SelectList GetAnalysisStatusList(bool includeEmpty, string selectedType)
        {
            return GetSelectList(Settings.ApplicationSettings.AvailableAnalysisStatus, includeEmpty, "-- select --", selectedType);
        }
