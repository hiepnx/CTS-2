					...
					<table class="formatTable">
						<tbody>
							...
							<tr>
								...
								<td >
									<%: Html.TextBoxFor(m => m.Ticket.Title, new {TabIndex = 1, style = "min-width:300px;width:100%;" })%>
								</td>
							</tr>
							...
							<tr>
								<th>
                                	...
                                	<td>
													<%: Html.DropDownListFor(m => m.Ticket.Type, Model.TicketTypeList, new { TabIndex = 2,style = "min-width:300px;width:100%;" })%>
												</td>
                                            <th>
													<%: Html.ValidationMessageFor(m => m.Ticket.Result, "*")%><%= Html.LabelFor(m => m.Ticket.Result) %>
												</th>
												<td>
													<%:  Html.DropDownListFor(m => m.Ticket.Result, Model.TestStatusList, new { TabIndex = 3 })%>
												</td>
												<th>
									...
									<table class="formatTable" cellpadding="0" cellspacing="0">
										<tbody>
                                            ...
                                            <th>
												...
												<td>
													<%:  Html.DropDownListFor(m => m.Ticket.Priority, Model.PriorityList, new { TabIndex = 3 })%>
												</td>	
												<td style="width: 100%;">
												</td>
							...
							<tr>
                                ...
                                <td>
													<%: Html.DropDownListFor(m => m.Ticket.Category, Model.CategoryList, new { TabIndex = 5, style="width:100%;" })%>
												</td>
                                            <th>
													<%: Html.ValidationMessageFor(m => m.Ticket.SubCategory, "*")%><%= Html.LabelFor(m => m.Ticket.SubCategory) %>
												</th>
												<td colspan ="3">
													<%:  Html.DropDownListFor(m => m.Ticket.SubCategory, Model.SubCategoryList, new { TabIndex = 6,style="width:100%" })%>
												</td>
                            ...
                            <tr>
								...
								<td >
									<%: Html.TextBoxFor(m => m.Ticket.TagList, new { style = "min-width:300px;width:450px;", TabIndex = 7 })%>
									<script type="text/javascript">
									    $(document).ready(function () {
                            ...
                            <tr>
								...
								<td >
									<%: Html.DropDownListFor(m => m.Ticket.Owner, Model.OwnersList, new { TabIndex = 8, style="width:100%" })%>
							...
							<tr>
								...
								<td >
                                    <%: Html.TextAreaFor(m => m.Ticket.Details, new {@Class = "Editor", TabIndex = 9, style="width:100%;",rows = "4"  })%>
									
								</td>
                                <th>
									<%: Html.ValidationMessageFor(m => m.Ticket.TestOutline, "*")%><%= Html.LabelFor(m => m.Ticket.TestOutline) %>
								</th>
								<td colspan ="3" >
                                    <%: Html.TextAreaFor(m => m.Ticket.TestOutline, new {@Class = "Editor", TabIndex = 10, style="width:100%;",rows = "4" })%>
									
								</td>
							</tr>


                            <%-- Target device & Target Version --%>
							<tr>
								<th>
									<%: Html.ValidationMessageFor(m => m.Ticket.TargetDevice, "*")%><%= Html.LabelFor(m => m.Ticket.TargetDevice) %>
								</th>
								<td >
                                    <%: Html.TextAreaFor(m => m.Ticket.TargetDevice, new {@Class = "Editor", TabIndex = 11 ,style="width:100%;",rows = "4" })%>
									
								</td>
                                <%--Target Version --%>
                                <th>
									<%: Html.ValidationMessageFor(m => m.Ticket.TargetVersion, "*")%><%= Html.LabelFor(m => m.Ticket.TargetVersion) %>
								</th>
								<td colspan="3" >
                                    <%: Html.TextAreaFor(m => m.Ticket.TargetVersion, new {@Class = "Editor", TabIndex = 12,style="width:100%;",rows = "4"  })%>
									
								</td>
							</tr>

                            <%-- Analysis Detail & Analysis Remark --%>
							<tr>
                                <%-- Analysis Detail --%>
								<th>
									<%: Html.ValidationMessageFor(m => m.Ticket.AnalysisDetail, "*")%><%= Html.LabelFor(m => m.Ticket.AnalysisDetail) %>
								</th>
								<td >
                                    <%: Html.TextAreaFor(m => m.Ticket.AnalysisDetail, new {@Class = "Editor", TabIndex = 13, style="width:100%;",rows = "4" })%>
									
								</td>
                                <%-- Analysis Remark --%>
                                <th>
									<%: Html.ValidationMessageFor(m => m.Ticket.AnalysisRemark, "*")%><%= Html.LabelFor(m => m.Ticket.AnalysisRemark) %>
								</th>
								<td colspan="3">
                                    <%: Html.TextAreaFor(m => m.Ticket.AnalysisRemark, new {@Class = "Editor", TabIndex = 14,style="width:100%;",rows = "4"  })%>
									
								</td>
							</tr>
                            
                            <%-- Analysis PIC & Analysis Status --%>
							<tr>
                                <%-- Analysis PIC --%>
								<th>
									<%: Html.ValidationMessageFor(m => m.Ticket.AssignedTo, "*")%><%= Html.LabelFor(m => m.Ticket.AssignedTo) %>
								</th>
								<td >
                                    <%: Html.DropDownListFor(m => m.Ticket.AssignedTo, Model.StaffList, new { TabIndex = 15,style="width:100%;" })%>
									<%--: Html.ValidationMessageFor(m => m.Ticket.Owner, "*")--%>
                                ...
                                <%-- Analysis Status --%>
                                <th>
									<%: Html.ValidationMessageFor(m => m.Ticket.CurrentStatus, "*")%><%= Html.LabelFor(m => m.Ticket.CurrentStatus) %>
								</th>
								<td  colspan="3">
                                    <%: Html.DropDownListFor(m => m.Ticket.CurrentStatus, Model.AnalysisStatusList, new { TabIndex = 16,style="width:100%;",rows = "4" })%>
							...
							<tr>
                                <%-- Analysis Note --%>
								<th>
									<%: Html.ValidationMessageFor(m => m.Ticket.AnalysisNote, "*")%><%= Html.LabelFor(m => m.Ticket.AnalysisNote) %>
								</th>
								<td >
                                    <%: Html.TextAreaFor(m => m.Ticket.AnalysisNote, new {@Class = "Editor", TabIndex = 17,style="width:100%;",rows = "4"  })%>
